...
Cloudogu EcoSystem is an open platform, which lets you choose how and where your team creates great software. Each service or tool 
...
automatically detects and responds to dependencies between Dōgus. Cloudogu EcoSystem is open source and it runs either on-premise 
or in the cloud. Cloudogu EcoSystem is developed by Cloudogu GmbH under [MIT License](https://cloudogu.com/license.html) and it 
